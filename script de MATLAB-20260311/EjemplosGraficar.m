...
%Una Posible asignación de marcadores
 ...
 posA=Datos.Pasada.Marcadores.Crudos.Valores.sacrum;
 posB=Datos.Pasada.Marcadores.Crudos.Valores.r_asis;
 posC=Datos.Pasada.Marcadores.Crudos.Valores.l_asis;

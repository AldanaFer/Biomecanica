...
cm_pie_der=Datos.Pasada.Marcadores.Crudos.Valores.r_heel+0.44*(Datos.CA.pie_punta_der-Datos.Pasada.Marcadores.Crudos.Valores.r_heel);
cm_pie_izq=Datos.Pasada.Marcadores.Crudos.Valores.l_heel+0.44*(Datos.CA.pie_punta_izq-Datos.Pasada.Marcadores.Crudos.Valores.l_heel);
